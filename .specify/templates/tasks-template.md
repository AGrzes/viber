...
**Tests**: The examples below include test tasks. Tests are OPTIONAL - include only when they meaningfully catch risk identified in the plan/spec.
...
- [ ] T004 Record chosen OSS dependencies and license notes (skip if none added)
...
- [ ] T040 [P] [US3] Contract test for [endpoint] in tests/contract/test_[name].py
- [ ] T041 [P] [US3] Integration test for [user journey] in tests/integration/test_[name].py
